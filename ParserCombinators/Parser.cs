        ...
        private static Parse<string> DecimalStringHelper(string x, bool front, int stelle)
        {
            return value =>
            {
                if (front)
                {
                    ...
                    if (parseResult.Succeeded)
                    {
                        string str = Convert.ToString(10 * Convert.ToInt32(x) + Convert.ToInt32(parseResult.Result));
                ...
                else
                {
                    ...
                    if (parseResult.Succeeded)
                    {
                        ...
                        string str = Convert.ToString(Convert.ToDecimal(x) + Convert.ToDecimal(dec));
